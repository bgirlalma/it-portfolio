      ...
      <ListContainer>
        <CardProjectOne>
          <div>
            ...
            <LinkContainer>
              <LinkCodeCardOne
                href="https://github.com/777Roma777/team-project"
                target="_blank"
              ...
              <LinkWebsiteCardOne
                href="https://777roma777.github.io/team-project/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Website
        ...
        <CardProjectTwo>
          ...
          <div>
            ...
            <LinkContainer>
              <LinkCodeCardTwo
                href="https://github.com/Michael-Zhinchyn/TASTY-TREATS"
                target="_blank"
                rel="noopener noreferrer"
              >
                Code
              ...
              <LinkWebsiteCardTwo
                href="https://michael-zhinchyn.github.io/TASTY-TREATS/index.html"
                target="_blank"
                rel="noopener noreferrer"
              >
                Website
        ...
        <CardProjectThree>
          <div>
            ...
            <LinkContainer>
              <LinkCode
                href="https://github.com/AnnaHort/HealthyHub"
                target="_blank"
                rel="noopener noreferrer"
              >
                Code
              ...
              <LinkWebsite
                href="https://annahort.github.io/HealthyHub/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Website
          ...
          <CardDesc>
            ...
            intake. <br />
            In this project, i served as a scrum master and developer. I
            developed the Welcome page, Body Parameters Page, Recommended Food,
            and Graphicals.
          </CardDesc>
        </CardProjectThree>
      </ListContainer>
